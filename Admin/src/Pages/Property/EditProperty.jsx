...
const EditProperty = () => {
    ...
    useEffect(() => {
        const fetchPropertyDetails = async () => {
            try {
                const response = await axios.get(`https://api.aashreyrealtors.com/api/v1/get-property-by-id/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(`https://api.aashreyrealtors.com/api/v1/update-property/${id}`, formData);
